...
public class Digests {
	...
	/**
	 * 将输入的内容进行SHA256散列，然后得到十六进制的SHA256散列值
	 * @param input
	 * @return
	 */
	public static String sha256(String input)
	{
		return Encodes.encodeHex(sha256(input.getBytes()));
	}
	...
	/**
	 * 将输入的内容进行SHA512散列，然后得到十六进制的SHA512散列值
	 * @param input
	 * @return
	 */
	public static String sha512(String input)
	{
		return Encodes.encodeHex(sha512(input.getBytes()));
	}
