...
CREATE INDEX SYS_ROLE_IDX1 ON T_SYS_ROLE(NAME);

-- 用戶角色關聯表
CREATE TABLE T_SYS_USER_ROLE
(
  URID                   INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) PRIMARY KEY,
  USERID                 INTEGER NOT NULL,
...
(
  RMID                   INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) PRIMARY KEY,
  RID                    INTEGER NOT NULL,
...
CREATE INDEX SYS_PARAMS_IDX1 ON T_SYS_PARAMS(SYSCODE);
